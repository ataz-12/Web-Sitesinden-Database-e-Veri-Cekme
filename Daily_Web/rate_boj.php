...
$(function(){
$("#W7866").paraceviriciWidget({
  widget:"boxrow",
  wData:{
    category:0,
    currency:"TRY-EUR-GBP-JPY-ZAR"
  },
  wSize:{
    wWidth:"100%",
    wHeight:180
...
zingchart.bind('rate', 'label_click', function(e){

...
Date 1:
 ...
 Date 2: <input type="date" name="tarih2" class="form-control">
      ...
      <div class="col-auto"> </br>
		...
		<div>
      <script type="text/javascript" src="http://finanswebde.com/fwebdev2/js/fwidget.js"></script>
      <div id="fwebdeconverter" style="width:500px;">
        <a title="Döviz ve Altın Çevirici Eklentisi" style="font-size:10;text-decoration:none;color:black" href="//finanswebde.com/"></a>
        </div>
        <script type="text/javascript">_fcepte.createConverter("currency",1112,205);
  </script>
</div>
	  </div>
		<?php
